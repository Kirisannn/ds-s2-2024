...
public class AggregationServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Server crash. Forced shutdown. Cleaning up files...");
        } finally { // Execute if server crashes
            try {
                Files.deleteIfExists(Paths.get(TEMP_FILE));
            } catch (IOException e) {
                System.err.println(ERROR_FAILED_DELETE + TEMP_FILE + " " + e.getMessage());
            }
        }
